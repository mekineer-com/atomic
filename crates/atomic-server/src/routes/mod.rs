...
pub fn configure_routes(cfg: &mut web::ServiceConfig) {
    ...
    cfg.route("/memu/entities", web::post().to(memu_entities::create));
    ...
    cfg.route(
        "/memu/entities/{id}/merge",
        web::post().to(memu_entities::merge),
    );
    cfg.route(
    ...
    cfg.route(
        "/memu/reviews/soul-summary/{id}",
        web::patch().to(memu_reviews::update_soul_summary),
    );
    cfg.route(
        "/memu/reviews/memory/{id}",
